...
/* package farm-0.1.0.0 */
#ifndef VERSION_farm
#define VERSION_farm "0.1.0.0"
#endif /* VERSION_farm */
#ifndef MIN_VERSION_farm
#define MIN_VERSION_farm(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_farm */
...
#define CURRENT_COMPONENT_ID "farm-0.1.0.0-inplace-farm"
